...
class JobForm(forms.ModelForm):
    class Meta:
        model = Job
        fields = [ "title", "company", "street_address", "city", "state", "zip_code", "country","employment_type", "description", "requirements", "min_salary", "max_salary", "is_active"
        ]
        widgets = {
            "description": forms.Textarea(attrs={"rows": 6}),
            "requirements": forms.Textarea(attrs={"rows": 4}),
        }
                # Add some visual improvements and placeholders
        widgets = {
            ...
            "description": forms.Textarea(attrs={"class": "form-control", "rows": 5, "placeholder": "Job responsibilities, mission, etc."}),
            "requirements": forms.Textarea(attrs={"class": "form-control", "rows": 4, "placeholder": "Required skills, tools, experience..."}),
